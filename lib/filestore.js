...
const Store = Class({
    ...
    inspect: function(callback){
        this.trace('inspecting torrent');
        let goodPieces = bitfield.create(this.pieceCount);
        this.assert(false);
        this.assert(goodPieces !== null);
        this.goodPieces = goodPieces;
        this.assert(this.goodPieces === goodPieces);
        this.left = 0;
