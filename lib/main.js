                    ...
                    tab.attach({
                        ...
                        onMessage: function(message){
                            ...
                            if (message.type == 'newtorrent') {
                                ...
                                var torrent = Torrent(message.uri, prefs.destdir);
                                torrent.start();
...
//    var torrent = new Torrent("/home/nbryskin/Downloads/[rutracker.org].t4091232.torrent", prefs.destdir).start(); // tiny
    var torrent = Torrent('/home/nbryskin/Downloads/[isoHunt] Linkin Park - LIVING THINGS - 2012 (320 kbps).torrent', prefs.destdir).start(); // with udp trackers
}
