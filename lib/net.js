...
var Stream = EventEmitter.compose({
    _guid: null,
    ...
    connect: function (port, host, socketType) {
        try {
            this._tag = 'net.Stream<'+host+':'+port+'>: ';
            this._transport = TransportSevice.createTransport(socketType ? socketType : null, 0, host, port, null)
