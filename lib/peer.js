...
const Peer = Class({
    ...
    initialize: function(key, host, port, torrent, connection){
        ...
        this.info('creating');
        this.stream = connection || new net.Socket();
        ...
        this.stream.on('readyState', (function(state) { this.trace('state changed to '+state); }).bind(this));
    ...
    onconnect: function () {
        ...
        this.debug('connected, sending handshake');
    ...
    doBitfield: function(data){
        this.debug('received bitfield message '+escape(data));
    ...
    doPiece: function(data){
        ...
        this.torrent.addPieceFragment(index, begin, block);
    },
    ...
    sendBitfield: function(){
        this.debug('sending bitfield='+this.torrent.store.goodPieces.getBitArray());
